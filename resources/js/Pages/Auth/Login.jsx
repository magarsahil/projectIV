...
export default function Login() {
    ...
    return (
        <AuthLayout image="/images/monkey.login2.jpg">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome back</h1>
            <p className="text-gray-500 text-sm mb-8">Login to your MeroBazar account</p>
            ...
            <form onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="mb-6">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <a href="/forgot-password" className="text-orange-500 text-sm hover:text-orange-600 transition-colors">
            ...
            <p className="text-center text-gray-500 text-sm mt-8">
                ...
                <a href="/register" className="text-orange-500 underline hover:text-orange-600 transition-colors">
                    Sign up
                </a>
            </p>
        </AuthLayout>
